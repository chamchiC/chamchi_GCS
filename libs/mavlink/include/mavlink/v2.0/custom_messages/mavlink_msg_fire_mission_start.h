...
typedef struct __mavlink_fire_mission_start_t {
 ...
 float takeoff_speed; /*< [m/s] Takeoff Speed (m/s)*/
 float flight_speed; /*< [m/s] Flight Speed (m/s)*/
...
#define MAVLINK_MSG_ID_FIRE_MISSION_START_LEN 24
#define MAVLINK_MSG_ID_FIRE_MISSION_START_MIN_LEN 24
#define MAVLINK_MSG_ID_60000_LEN 24
#define MAVLINK_MSG_ID_60000_MIN_LEN 24
...
#define MAVLINK_MESSAGE_INFO_FIRE_MISSION_START { \
    ...
    "FIRE_MISSION_START", \
    9, \
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 20, offsetof(mavlink_fire_mission_start_t, target_system) }, \
         { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 21, offsetof(mavlink_fire_mission_start_t, target_component) }, \
         ...
         { "auto_fire", NULL, MAVLINK_TYPE_UINT8_T, 0, 22, offsetof(mavlink_fire_mission_start_t, auto_fire) }, \
         { "max_projectiles", NULL, MAVLINK_TYPE_UINT8_T, 0, 23, offsetof(mavlink_fire_mission_start_t, max_projectiles) }, \
         { "takeoff_speed", NULL, MAVLINK_TYPE_FLOAT, 0, 12, offsetof(mavlink_fire_mission_start_t, takeoff_speed) }, \
         { "flight_speed", NULL, MAVLINK_TYPE_FLOAT, 0, 16, offsetof(mavlink_fire_mission_start_t, flight_speed) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_FIRE_MISSION_START { \
 ...
 * @param takeoff_speed [m/s] Takeoff Speed (m/s)
 * @param flight_speed [m/s] Flight Speed (m/s)
...
static inline uint16_t mavlink_msg_fire_mission_start_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint8_t target_component, int32_t target_lat, int32_t target_lon, float target_alt, uint8_t auto_fire, uint8_t max_projectiles, float takeoff_speed, float flight_speed)
{
    ...
    _mav_put_float(buf, 12, takeoff_speed);
    _mav_put_float(buf, 16, flight_speed);
    _mav_put_uint8_t(buf, 20, target_system);
    _mav_put_uint8_t(buf, 21, target_component);
    _mav_put_uint8_t(buf, 22, auto_fire);
    _mav_put_uint8_t(buf, 23, max_projectiles);
    ...
    packet.takeoff_speed = takeoff_speed;
    packet.flight_speed = flight_speed;
...
{
    return mavlink_msg_fire_mission_start_pack(system_id, component_id, msg, fire_mission_start->target_system, fire_mission_start->target_component, fire_mission_start->target_lat, fire_mission_start->target_lon, fire_mission_start->target_alt, fire_mission_start->auto_fire, fire_mission_start->max_projectiles, fire_mission_start->takeoff_speed, fire_mission_start->flight_speed);
}
...
{
    return mavlink_msg_fire_mission_start_pack_chan(system_id, component_id, chan, msg, fire_mission_start->target_system, fire_mission_start->target_component, fire_mission_start->target_lat, fire_mission_start->target_lon, fire_mission_start->target_alt, fire_mission_start->auto_fire, fire_mission_start->max_projectiles, fire_mission_start->takeoff_speed, fire_mission_start->flight_speed);
}
...
{
    return mavlink_msg_fire_mission_start_pack_status(system_id, component_id, _status, msg,  fire_mission_start->target_system, fire_mission_start->target_component, fire_mission_start->target_lat, fire_mission_start->target_lon, fire_mission_start->target_alt, fire_mission_start->auto_fire, fire_mission_start->max_projectiles, fire_mission_start->takeoff_speed, fire_mission_start->flight_speed);
}
...
static inline void mavlink_msg_fire_mission_start_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, int32_t target_lat, int32_t target_lon, float target_alt, uint8_t auto_fire, uint8_t max_projectiles, float takeoff_speed, float flight_speed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_FIRE_MISSION_START_LEN];
    _mav_put_int32_t(buf, 0, target_lat);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_fire_mission_start_send(chan, fire_mission_start->target_system, fire_mission_start->target_component, fire_mission_start->target_lat, fire_mission_start->target_lon, fire_mission_start->target_alt, fire_mission_start->auto_fire, fire_mission_start->max_projectiles, fire_mission_start->takeoff_speed, fire_mission_start->flight_speed);
#else
 ...
 */
static inline void mavlink_msg_fire_mission_start_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, int32_t target_lat, int32_t target_lon, float target_alt, uint8_t auto_fire, uint8_t max_projectiles, float takeoff_speed, float flight_speed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field takeoff_speed from fire_mission_start message
 *
 * @return [m/s] Takeoff Speed (m/s)
 */
static inline float mavlink_msg_fire_mission_start_get_takeoff_speed(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  12);
}

/**
 * @brief Get field flight_speed from fire_mission_start message
 *
 * @return [m/s] Flight Speed (m/s)
 */
static inline float mavlink_msg_fire_mission_start_get_flight_speed(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_fire_mission_start_decode(const mavlink_message_t* msg, mavlink_fire_mission_start_t* fire_mission_start)
{
    ...
    fire_mission_start->takeoff_speed = mavlink_msg_fire_mission_start_get_takeoff_speed(msg);
    fire_mission_start->flight_speed = mavlink_msg_fire_mission_start_get_flight_speed(msg);
